...
export type PointerCoords = Readonly<{
  x: number;
  y: number;
  /** Pressure applied (0-1), for Apple Pencil and other pressure-sensitive devices */
  pressure?: number;
  /** Barrel pressure for Apple Pencil (-1 to 1) */
  tangentialPressure?: number;
  /** Tilt angle in X direction (-90 to 90 degrees) */
  tiltX?: number;
  /** Tilt angle in Y direction (-90 to 90 degrees) */
  tiltY?: number;
  /** Rotation of the pen (0-359 degrees) */
  twist?: number;
  /** Type of pointer device ('mouse', 'pen', 'touch', etc.) */
  pointerType?: string;
}>;
